package com.paradox.currency.ui.viewmodels
...
/**
 * view model class used by [com.paradox.currency.ui.CurrenciesFragment]
 */
@HiltViewModel
class CurrenciesViewModel @Inject internal constructor(private val useCase: CurrencyUseCases) :
     ...
     * error case is handled using custom exceptions. Take a look at [com.paradox.currency.data.exceptions.NetworkException]
     * and [com.paradox.currency.data.exceptions.GenericException]
     */
