...
import com.paradox.currency.data.repositories.LocalCurrencyRepository
import com.paradox.currency.usecases.CurrencyUseCases
...
class UseCaseTest {
    ...
    fun fetchingAllCurrencies() {
        val allCurrencies = runBlocking { useCase.getAllCurrencies()}
    ...
    fun getRateError() {
        ...
        runBlocking {  useCase.getRatesByCurrencyAndAmount(invalidCurrency, 4.0)
    }
    }
    ...
    fun getRatesByAmountAndCurrency() {
        ...
        val amountValues =runBlocking { useCase.getRatesByCurrencyAndAmount(jpyCurrency!!, amount)}
        ...
        val higherAmountValues =runBlocking { useCase.getRatesByCurrencyAndAmount(jpyCurrency!!, higherAmount)}
        ...
        val highestAmountValues = runBlocking {useCase.getRatesByCurrencyAndAmount(jpyCurrency!!, highestAmount)}
